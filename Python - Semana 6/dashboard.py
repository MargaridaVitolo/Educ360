...
consultas_unidade['unidade']= consultas_unidade['unidade'].str.capitalize()
...
fat_unidade['unidade']= fat_unidade['unidade'].str.capitalize()
...
#Capitalizar o saída dos dados texto
df_filtrado['unidade'] = df_filtrado['unidade'].str.capitalize()
df_filtrado['tipoconsulta'] = df_filtrado['tipoconsulta'].str.capitalize()
